...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@#
#@                                                    @#
#@  EXTENDED SEIRS MODELS (Source codes)              @#
#@                                                    @#
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@#
########################################################
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@#
#@                                                    @#
#@  EXTENDED SEIRS MODEL FOR TESTING HOUSEHOLD        @#
#@                                                    @#
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@#
########################################################
...
class ExtSEIRSNetworkModel_HSHD():
    """
    A class to simulate the Extended SEIRS Stochastic Network Model
    ===================================================
    Params: 
            G               Network adjacency matrix (numpy array) or Networkx graph object.邻接矩阵
            beta            Rate of transmission (global interactions)传播率
            beta_local      Rate(s) of transmission between adjacent individuals (optional)相邻个体间的传播率
            beta_asym       Rate of transmission (global interactions)传播率
            beta_asym_local Rate(s) of transmission between adjacent individuals (optional)相邻个体间的传播率
            sigma           Rate of progression to infectious state (inverse of latent period) 进展至感染状态的速率（潜伏期的倒数）            
            lamda           Rate of progression to infectious (a)symptomatic state (inverse of prodromal period)进展到症状状态的速率
            eta             Rate of progression to hospitalized state (inverse of onset-to-admission period) 进展到住院状态的速率          
            gamma           Rate of recovery for non-hospitalized symptomatic individuals (inverse of symptomatic infectious period)                                 非住院症状患者的康复率
            gamma_asym      Rate of recovery for asymptomatic individuals (inverse of asymptomatic infectious period)无症状个体的康复率              
            gamma_H         Rate of recovery for hospitalized symptomatic individuals (inverse of hospitalized infectious period)                                   有症状的住院患者的康复率
            mu_H            Rate of death for hospitalized individuals (inverse of admission-to-death period)死亡率              
            xi              Rate of re-susceptibility (upon recovery)再感染率（恢复后）
            mu_0            Rate of baseline death基线死亡率
            nu              Rate of baseline birth基线出生率
            a               Probability of an infected individual remaining asymptomatic感染者保持无症状的可能性
            h               Probability of a symptomatic individual being hospitalized 有症状的个人住院的可能性 
            f               Probability of death for hospitalized individuals (case fatality rate) 病死率                        
            p               Probability of individuals interacting with global population  个体与全球人口互动的概率            
            
            G_Q             Quarantine adjacency matrix (numpy array) or Networkx graph object.隔离邻接矩阵
            beta_Q          Rate of transmission for isolated individuals (global interactions)隔离个体的传染率
            beta_Q_local    Rate(s) of transmission (exposure) for adjacent isolated individuals (optional)相邻隔离个体的传播速率              
            sigma_Q         Rate of progression to infectious state for isolated individuals 隔离个体进展为感染状态的速率          
            lamda_Q         Rate of progression to infectious (a)symptomatic state for isolated individuals 隔离个体进展为症状状态的速率           
            eta_Q           Rate of progression to hospitalized state for isolated individuals 隔离个体进展至住院状态的比率            
            gamma_Q_sym     Rate of recovery for non-hospitalized symptomatic individuals for isolated individuals 
                        隔离的个体中非住院患者的恢复概率
            gamma_Q_asym    Rate of recovery for asymptomatic individuals for isolated individuals  隔离的个体中无症状患者的恢复概率            
            theta_E         Rate of random testing for exposed individuals 暴露个体的随机检测率            
            theta_pre       Rate of random testing for infectious pre-symptomatic individuals 感染性症状前个体的随机检测率             
            theta_sym       Rate of random testing for infectious symptomatic individuals 感染性症状个体的随机检测率             
            theta_asym      Rate of random testing for infectious asymptomatic individuals 无症状传染性个体的随机检测率            
            phi_E           Rate of testing when a close contact has tested positive for exposed individuals
                          密切接触者检测出阳性时的检测率               
            phi_pre         Rate of testing when a close contact has tested positive for infectious pre-symptomatic individuals                                     密切接触者对感染前症状个体检测呈阳性时的检测率
            phi_sym         Rate of testing when a close contact has tested positive for infectious symptomatic individuals                                        当密切接触者对有传染性症状的个体检测呈阳性时的检测率
            phi_asym        Rate of testing when a close contact has tested positive for infectious asymptomatic individuals 
                         当密切接触者对无症状的个体检测呈阳性时的检测率
            psi_E           Probability of positive test for exposed individuals 暴露个体的阳性检测概率              
            psi_pre         Probability of positive test for infectious pre-symptomatic individuals 感染性症状前个体的阳性检测概率               
            psi_sym         Probability of positive test for infectious symptomatic individuals 有传染性症状的个体的阳性检测概率               
            psi_asym        Probability of positive test for infectious asymptomatic individuals 无传染性症状的个体的阳性检测概率              
            q               Probability of isolated individuals interacting with global population隔离人与外界的接触概率
            isolation_time  Time to remain in isolation upon positive test, self-isolation, etc. 在阳性检测、自我隔离等情况下保持隔离的时间           
            
            initE           Initial number of exposed individuals初始接触人数
            initI_pre       Initial number of infectious pre-symptomatic individuals感染性症状前个体的初始数量
            initI_sym       Initial number of infectious symptomatic individuals有感染症状的个体的初始数量
            initI_asym      Initial number of infectious asymptomatic individuals无感染症状的个体的初始数量
            initH           Initial number of hospitalized individuals初始住院人数
            initR           Initial number of recovered individuals 初始康复人数    
            initF           Initial number of infection-related fatalities与感染有关的死亡人数
            initQ_S         Initial number of isolated susceptible individuals隔离易感个体的初始数量
            initQ_E         Initial number of isolated exposed individuals隔离暴露个体的初始数量
            initQ_pre       Initial number of isolated infectious pre-symptomatic individuals隔离的感染前症状个体的初始数量
            initQ_sym       Initial number of isolated infectious symptomatic individuals隔离的有症状个体的初始数量
            initQ_asym      Initial number of isolated infectious asymptomatic individuals隔离的无症状个体的初始数量
            initQ_R         Initial number of isolated recovered individuals隔离康复者的初始数量
                            (all remaining nodes initialized susceptible)   
    """
    def __init__(self, G, HI, HS, HAGE, beta, sigma, lamda, gamma, 
                    gamma_asym=None, eta=0, gamma_H=None, mu_H=0, alpha=1.0, xi=0, mu_0=0, nu=0, a=0, h=0, f=0, p=0,             
                    beta_local=None, beta_asym=None, beta_asym_local=None, beta_pairwise_mode='infected', delta=None, delta_pairwise_mode=None,
                    G_Q=None, beta_Q=None, beta_Q_local=None, sigma_Q=None, lamda_Q=None, eta_Q=None, gamma_Q_sym=None, gamma_Q_asym=None, alpha_Q=None, delta_Q=None,
                    theta_S=0, theta_E=0, theta_pre=0, theta_sym=0, theta_asym=0, phi_S=0, phi_E=0, phi_pre=0, phi_sym=0, phi_asym=0,    
        ...
        # Model Parameters:
        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        self.parameters = { 'G':G, 'G_Q':G_Q,'HI':HI,'HS':HS,'HAGE':HAGE,
                            'beta':beta, 'sigma':sigma, 'lamda':lamda, 'gamma':gamma, 
                            'eta':eta, 'gamma_asym':gamma_asym, 'gamma_H':gamma_H, 'mu_H':mu_H, 
                            'xi':xi, 'mu_0':mu_0, 'nu':nu, 'a':a, 'h':h, 'f':f, 'p':p, 
                            'beta_local':beta_local, 'beta_asym':beta_asym, 'beta_asym_local':beta_asym_local, 'beta_pairwise_mode':beta_pairwise_mode,
...
#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    def update_parameters(self):
        ...
        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        self.G = self.parameters['G']
        self.HI = self.parameters['HI']
        self.HS = self.parameters['HS']
        self.HAGE= self.parameters['HAGE']
        # Adjacency matrix:
        if type(self.G)==numpy.ndarray:
            self.A = scipy.sparse.csr_matrix(self.G)
        elif type(self.G)==networkx.classes.graph.Graph:
...
#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^     
    ...
    def run_iteration(self, max_dt=None):
        ...
        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        # if(self.t >= self.tmax or (self.total_num_infected(self.tidx) < 1 and self.total_num_isolated(self.tidx) < 1)):
        if(self.t >= self.tmax):   # Terminate if tmax reached
            self.finalize_data_series()
            return False
